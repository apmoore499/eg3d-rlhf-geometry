...
REWARD_ID = "7wnzkgie"
ORIG_PKL = reported_run_dir() / "network-snapshot-002068_LAST.pkl"
...
OUT_PATH = (
    ...
    / "eg3d_tuned_reward_vs_truncation.json"
)
...
def main():
    ...
    sigma_aug = hydra.utils.instantiate(
        OmegaConf.load(
            RLHF_CORE_ROOT / "RWD_MODELS_FOR_TUNING" / REWARD_ID / "run_config.yaml"
