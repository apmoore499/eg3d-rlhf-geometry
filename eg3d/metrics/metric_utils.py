...
def compute_feature_stats_for_dataset(
    ...
    **stats_kwargs,
    ...
    if data_loader_kwargs is None:
        # Use num_workers=0 to avoid multiprocessing issues with ZIP files and 'spawn' method
    ...
    for images, _labels in tqdm.tqdm(torch.utils.data.DataLoader(dataset=dataset, sampler=item_subset, batch_size=batch_size, pin_memory=True, num_workers=0)):
        if images.shape[1] == 1:
