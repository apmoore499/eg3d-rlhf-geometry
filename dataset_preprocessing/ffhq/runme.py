...
for subdir in os.listdir(realign1500_dir):
    ...
    for filename in os.listdir(os.path.join(realign1500_dir, subdir)):
        shutil.move(
            os.path.join(realign1500_dir, subdir, filename),
            os.path.join(realign1500_dir, filename),
        )
...
gdown.download(
    "https://drive.google.com/uc?id=1KdVf2lIepGECRaANGhfuR7mDpJ5nfb9K",
    "realign1500/cropping_params.json",
    quiet=False,
)
...
gdown.download(
    "https://drive.google.com/uc?id=14mzYD1DxUjh7BGgeWKgXtLHWwvr-he1Z",
    "final_crops/dataset.json",
    quiet=False,
)
