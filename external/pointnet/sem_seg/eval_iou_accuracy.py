...
gt_label_filenames = [f.rstrip(r'_pred\.txt') + '_gt.txt' for f in pred_data_label_filenames]
...
print('Overall accuracy: {}'.format(sum(true_positive_classes)/float(sum(positive_classes))))
